...
googleRouter.get("/protected", isLoggedIn, async (req, res) => {
  ...
  try {
    ...
    res.send(`<a href="https://beautyblaze.netlify.app/" id="myid" style="display: flex; justify-content: center; align-items: center; height: 100vh; background-color: #222222; margin: 0; padding: 0; overflow: scroll;">
                      <img src="https://mir-s3-cdn-cf.behance.net/project_modules/hd/b6e0b072897469.5bf6e79950d23.gif" alt="">
                  </a>
                  <script>
                  localStorage.setItem("token", ${JSON.stringify(token)});
                  localStorage.setItem("id", ${JSON.stringify(newuser._id)});
